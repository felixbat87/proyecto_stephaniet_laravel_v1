                                ...
                                <div class="card-body border-top">
                                    ...
                                    <div class="">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li class="mb-2"><i class="fas fa-fw fa-envelope mr-2"></i>Correo electrónico: {{$perfil->CORREO}}</li>
                                            <li class="mb-2"><i class="fas fa-briefcase mr-2"></i>Cargo: {{$perfil->CARGO}}</li>
                                            <li class="mb-2"><i class="fas fa-building mr-2"></i>Dirección: {{$perfil->DIRECCION}}</li>
                                        </ul>
                                        @endforeach
                                    </div>
                                </div>
