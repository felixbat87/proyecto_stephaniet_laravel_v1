...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="{{('proyecto_muci/assets/vendor/fonts/fontawesome/css/fontawesome-all.css')}}" />
            ...
            <div class="influence-profile">
                <div class="container-fluid dashboard-content">
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="/perfil" class="breadcrumb-link">Perfil</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Horas Laboradas</li>
                                            <br />
                                        </ol>
                                    </nav>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"> 
                            <div class="card">
                                <h5 class="card-header">A continuación se muestran los últimos 15 días registrados:</h5>
                                ...
                                <div class="col-xl-12 col-lg-4 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h3 class="card-header"><center>Horas Laboradas</center></h3>
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    @foreach ($usuario_marcacion as $data)
                                                    <tr>
                                                        <td>{{$data->FECHA}}</td>
                                                        <td>{{$data->ENTRADA}}</td>
                                                        <td>{{$data->SALIDA}}</td>
                                            ...
                                            <br><br>
                                            <h3 class="card-header"><center>Horas Totales</center></h3>
                                            <table class="table table-striped">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                        @foreach ($compensatorio as $hora)
                                                        <td>{{$hora->HORAS_COMP}}</td>
                                                        @endforeach
                                                        @foreach ($horas_trabajadas as $data )
                                                        <td>{{$data->HORAS}}</td>
                                                        @endforeach
                                                    </tr>
                                        ...
                                        <br>
                                        <!--BOTON IMPRIMIR--> 
                                        <a href="/pdf_view/{{Crypt::encrypt(session()->get('ID'))}}" class="btn btn-info btn-sm" target=“_blank”>Ver PDF  <i class="fas fa-file-pdf"></i></a>
